...
complete -c changes -n 'test (__changes_completion_context) = "note add"' -f -l commit -r -a '(__changes_completion_values_11)' -d 'First-parent commit comparison'
complete -c changes -n 'test (__changes_completion_context) = "note add"' -l config -r -d 'YAML configuration file'
complete -c changes -n 'test (__changes_completion_context) = "note add"' -f -l file -r -a '(__changes_completion_values_12)' -d 'Repository file to annotate'
complete -c changes -n 'test (__changes_completion_context) = "note add"' -f -l from -r -a '(__changes_completion_values_13)' -d 'Left revision'
...
complete -c changes -n 'test (__changes_completion_context) = "note add"' -f -l origin -r -a '(__changes_completion_values_14)' -d 'Author kind'
complete -c changes -n 'test (__changes_completion_context) = "note add"' -f -l provider -r -a '(__changes_completion_values_15)' -d 'Writable note provider'
complete -c changes -n 'test (__changes_completion_context) = "note add"' -l session -r -d 'Harness session identifier'
complete -c changes -n 'test (__changes_completion_context) = "note add"' -f -l side -r -a '(__changes_completion_values_16)' -d 'Diff side'
...
complete -c changes -n 'test (__changes_completion_context) = "note add"' -f -l to -r -a '(__changes_completion_values_17)' -d 'Right revision'
complete -c changes -n 'test (__changes_completion_context) = "note list"' -f -l commit -r -a '(__changes_completion_values_18)' -d 'First-parent commit comparison'
complete -c changes -n 'test (__changes_completion_context) = "note list"' -l config -r -d 'YAML configuration file'
complete -c changes -n 'test (__changes_completion_context) = "note list"' -f -l from -r -a '(__changes_completion_values_19)' -d 'Left revision'
complete -c changes -n 'test (__changes_completion_context) = "note list"' -l json -d 'Print JSON'
complete -c changes -n 'test (__changes_completion_context) = "note list"' -f -l provider -r -a '(__changes_completion_values_20)' -d 'Note provider'
complete -c changes -n 'test (__changes_completion_context) = "note list"' -l staged -d 'Compare the index'
complete -c changes -n 'test (__changes_completion_context) = "note list"' -f -l to -r -a '(__changes_completion_values_21)' -d 'Right revision'
...
complete -c changes -f -n 'test (__changes_completion_context) = "provider list"' -a '(__changes_completion_values_22)'
...
complete -c changes -f -n 'test (__changes_completion_context) = "provider validate"' -a '(__changes_completion_values_23)'
